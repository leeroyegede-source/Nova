...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-20 px-6 relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-indigo-900/20 rounded-full blur-[100px] -z-10" />
      ...
      >
        <div className="glass-panel p-10 border border-white/10 shadow-2xl">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Start building with NovaAI for free</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
            Already have an account? <Link href="/login" className="text-white font-medium hover:text-blue-400 transition-colors">Sign in</Link>
          </p>
        </div>
      </motion.div>
    </div>
